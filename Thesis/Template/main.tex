...
Even though BERT was pretrained on a non domain-specific dataset, it showed better results than the LSTM which can learn domain-specific terminology. \\
...
\noindent\textbf{LSTM}\\
The LSTM finds its optimal hyperparameters with an accuracy of 89\% after three epochs, after which it seems to start overfitting a little bit.
...
accuracy keeps improving. The same can be argued for the loss.
...
The optimal hyperparameters are an AdamW optimizer, a learning rate of 1e-5 and eps of ABC.
