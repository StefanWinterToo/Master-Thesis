...
\begin{abstract}
    ...
    on how to best measure sentiment of the discussion board. One of the challenges when measuring sentiment of WallStreetBets is the usage of novel 
...
for market participants - depending on their timing. \cite{das2007yahoo} show that changes in investor sentiment and discussion board activity can be a cause of increased volatility.\\
However, it was not the rapid price appreciation in the beginning of the short-squeeze that amazed market participants. Instead, it was the unprecedented decentralized and coordinated buying of Gamestop shares by members of the WallStreetBets 
...
\begin{itemize}
    \item[RQ2] \emph{Which sentiment analysis approach performs best on predefined evaluation metrics?}
\end{itemize}
