...
The identified optimal hyperparameters are an Adam optimizer and a dropout rate of zero.\\
...
For hyperparameter tuning the \emph{optimizer} and its \emph{learning rate}, which is used to find the minimum of a loss function, are analyzed.
...
in between, neutral sentiment is assigned \citep{hutto2015vader}. To obtain optimal evaluation metrics the thresholds 0.03, 0.05, 0.07 and 0.10 and their negative counterparts were
analyzed.
...
The optimal hyperparameters are an AdamW optimizer, a learning rate of 1e-5 and eps of 1e-8. \\
