...
\begin{abstract}
    ...
    to measure the sentiment of WallStreetBets. Furthermore, this thesis will demonstrate that stock prices can be predicted based on
    sentiment, albeit other input features show better predictive capabilities.
\end{abstract}
    ...
    \scalebox{0.93}{
        \begin{tabular}{lllrr}
            \toprule
                ...
                \midrule
                \multirow{1}{*}{VADER}      & 0.39          & 0.36          & 0.39      & 0.37                      \\
